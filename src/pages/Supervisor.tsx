...
import { Users, TrendingUp, Package, Award, User, MapPin, Clock } from "lucide-react";
import { Badge } from "@/components/ui/badge";

const Supervisor = () => {
  const [selectedEvent] = useState("current");
      ...
      <Tabs defaultValue="overview" className="w-full">
        ...
        <div className="sticky top-0 bg-white z-20 shadow-sm border-b border-border">
          <div className="px-4 pt-4 pb-3">
            <h1 className="text-2xl font-bold mb-3">Панель супервайзера</h1>
